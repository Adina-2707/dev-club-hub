...
const translations = {
  ...
  "alumni.noSocialLinksDesc": { ru: "Этот выпускник ещё не добавил социальные ссылки.", en: "This alumni has not added any social links yet." },
  "alumni.socialLinks": { ru: "Социальные ссылки", en: "Social Links" },
  "alumni.github": { ru: "GitHub", en: "GitHub" },
  ...
  "mentor.schedule.overlapError": { ru: "Слот пересекается с существующим", en: "This slot overlaps with an existing slot" },
  "mentor.schedule.invalidTime": { ru: "Время окончания должно быть после времени начала", en: "End time must be after start time" },
  "mentor.schedule.fillFields": { ru: "Пожалуйста, заполните все поля", en: "Please fill in all fields" },
